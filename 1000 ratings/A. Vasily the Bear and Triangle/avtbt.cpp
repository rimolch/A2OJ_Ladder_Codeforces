...
int main(){
    ...
    cin>>x>>y;
    s=abs(x)+abs(y);
    //we can use it for simply --> printf("%d %d %d %d",x<0?-s:0,   x<0?0:y>0?s:-s,          x<0?0:s,    x<0?y>0?s:-s:0);
    /*
       input --> 10 5         input ---> -10 5        input---> 10 -5           input---> -10 -5
      output --->0 15 15 0    output---> -15 0 0 15   output---> 0 -15 15 -5    output---> -15 0 0 -15
    */
    if(x<0){
        cout<<-s<<" ";
    }
